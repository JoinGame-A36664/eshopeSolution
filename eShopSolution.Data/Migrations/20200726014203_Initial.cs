...
namespace eShopSolution.Data.Migrations
{
    ...
    {                                                        // kiểu tạo ra khung sql bằng c#
        // khi chạy lệnh Add-Migration Initial
        // nó tự Genrate code như bảng trong sql
        // UP tạo bảng DOWN xóa bảng
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 7, 26, 8, 42, 3, 177, DateTimeKind.Local).AddTicks(3079)),
